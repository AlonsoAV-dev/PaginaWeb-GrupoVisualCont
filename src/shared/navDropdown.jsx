    ...
    <div className={`relative ${className}`} ref={dropdownRef}>
      <button
        ...
        className={`flex items-center gap-1 transition-colors ${
          isOpen
            ? "text-[#257CD0] dark:text-[#257CD0]"
            : "text-black dark:text-white hover:text-[#257CD0] dark:hover:text-[#257CD0]"
        }`}
        aria-expanded={isOpen}
        aria-haspopup="true"
      >
        {trigger}
        <ChevronDown className={`w-4 h-4 transition-transform ${isOpen ? "rotate-180 text-[#257CD0]" : ""}`} />
      </button>
                      ...
                      >
                        ...
                        <div className="flex-1">
                          <div className="flex items-center">
                            <h3 className="text-sm font-medium text-gray-900 dark:text-white group-hover:text-[#257CD0] dark:group-hover:text-[#257CD0] transition-colors duration-200">
                              {item.title}
                            </h3>
                            <ExternalLink className="w-3.5 h-3.5 ml-1.5 text-gray-400 group-hover:text-[#257CD0]" />
                          </div>
                          {item.description && (
